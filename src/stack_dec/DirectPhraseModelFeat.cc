...
/*                                                                  */
/* Definitions file: DirectPhraseModelFeat.cc                       */
/*                                                                  */
/********************************************************************/
...
template<>
DirectPhraseModelFeat<PhrScoreInfo>::HypScoreInfo
DirectPhraseModelFeat<PhrScoreInfo>::extensionScore(const std::vector<std::string>& srcSent,
