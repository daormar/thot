...
/**
 * @file LevelDbDictFeat.cc
 * 
 * @brief Definitions file for LevelDbDictFeat.h
 */
...
template<>
LevelDbDictFeat<PhrScoreInfo>::HypScoreInfo
LevelDbDictFeat<PhrScoreInfo>::extensionScore(const std::vector<std::string>& srcSent,
