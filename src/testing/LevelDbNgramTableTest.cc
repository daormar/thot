...
void LevelDbNgramTableTest::testAddTrgWithEmptySrc()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(5.0, tc.get_c_s(), EPSILON);

    tab->incrCountsOfEntryLog(s, t, lc);
    tc = tab->cSrc(t_vec);

    CPPUNIT_ASSERT_DOUBLES_EQUAL(10.0, tc.get_c_s(), EPSILON);
}
...
void LevelDbNgramTableTest::testCTrg()
{
    ...
    // Validate results
    CPPUNIT_ASSERT_DOUBLES_EQUAL(47.0, tc1.get_c_s(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(24.0, tc2.get_c_s(), EPSILON);
}
...
void LevelDbNgramTableTest::testLogCountRetrieving()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(47.0, sc1.get_c_s(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(24.0, sc2.get_c_s(), EPSILON);

    CPPUNIT_ASSERT_DOUBLES_EQUAL(47.0, tc1.get_c_s(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(24.0, tc2.get_c_s(), EPSILON);
    
    CPPUNIT_ASSERT_DOUBLES_EQUAL(46.0, stc1.get_c_st(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(23.0, stc2.get_c_st(), EPSILON);
}
...
void LevelDbNgramTableTest::testStoreFloatValues()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(s_count_val, s_count.get_c_s(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(st_count_val, st_count.get_c_st(), EPSILON);
}
...
void LevelDbNgramTableTest::testStoreAndRestoreSrcInfo()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, s1_count.get_c_s(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(23.0, s2_count.get_c_s(), EPSILON);
}
...
void LevelDbNgramTableTest::testAddTableEntry()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(7.0, tab->cSrc(s).get_c_s(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(5.0, tab->cSrcTrg(s, t).get_c_st(), EPSILON);
}
...
void LevelDbNgramTableTest::testIncrCountsOfEntryLog()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(3.0, tab->cSrcTrg(s, t1).get_c_st(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(17.0, tab->cSrcTrg(s, t2).get_c_st(), EPSILON);
}
...
void LevelDbNgramTableTest::testRetrievingSubphrase()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, c.get_c_s(), EPSILON);

    tab->incrCountsOfEntryLog(s2, t2, LogCount(log(3)));
    c = tab->getSrcTrgInfo(s2, t2, found);

    CPPUNIT_ASSERT( found );
    CPPUNIT_ASSERT_DOUBLES_EQUAL(3.0, c.get_c_s(), EPSILON);
...
void LevelDbNgramTableTest::testGetEntriesForSource()
{
    ...
    CPPUNIT_ASSERT( found );
    CPPUNIT_ASSERT_DOUBLES_EQUAL(2.0, node.size(), EPSILON);
    // Krzywe phrases
    found = tab->getEntriesForSource(s2, node);
    CPPUNIT_ASSERT( found );
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, node.size(), EPSILON);
    // Jeziorak phrases
...
void LevelDbNgramTableTest::testGetNbestForSrc()
{
    ...
    iter = node.begin();
    CPPUNIT_ASSERT_DOUBLES_EQUAL(t1, iter->second, EPSILON);
    iter++;
    CPPUNIT_ASSERT_DOUBLES_EQUAL(t3, iter->second, EPSILON);
    iter++;
    CPPUNIT_ASSERT_DOUBLES_EQUAL(t2, iter->second, EPSILON);
    iter++;
    CPPUNIT_ASSERT_DOUBLES_EQUAL(t4, iter->second, EPSILON);
}
...
void LevelDbNgramTableTest::testIteratorsLoop()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(2.0, d[s1].first.get_c_s(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, d[s1].second.get_c_s(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(2.0, d[tab->getSrcTrg(s1, t1)].first.get_c_st(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, d[tab->getSrcTrg(s1, t1)].second.get_c_s(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, d[tab->getSrcTrg(s2, t2)].first.get_c_st(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, d[tab->getSrcTrg(s2, t2)].second.get_c_s(), EPSILON);
...
void LevelDbNgramTableTest::testIteratorsOperatorsPlusPlusStar()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(2.0f, d[s].first.get_c_s(), EPSILON);
    CPPUNIT_ASSERT_EQUAL(1, d[s].second);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(2.0, d[tab->getSrcTrg(s, t)].first.get_c_st(), EPSILON);
...
void LevelDbNgramTableTest::testLoadedDataCorrectness()
{
    ...
    // Check count values
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, tab->cSrcTrg(s1, t1_1).get_c_st(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(2.0, tab->cSrcTrg(s1, t1_2).get_c_st(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(4.0, tab->cSrcTrg(s1, t1_3).get_c_st(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(8.0, tab->cSrcTrg(s1, t1_4).get_c_st(), EPSILON);

    CPPUNIT_ASSERT_DOUBLES_EQUAL(16.0, tab->cSrcTrg(s2, t2_1).get_c_st(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(32.0, tab->cSrcTrg(s2, t2_2).get_c_st(), EPSILON);

    CPPUNIT_ASSERT_DOUBLES_EQUAL(64.0, tab->cSrcTrg(s3, t3_1).get_c_st(), EPSILON);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(128.0, tab->cSrcTrg(s3, t3_2).get_c_st(), EPSILON);
