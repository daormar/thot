...
std::string JsonTranslationMetadataTest::getJsonString(void)
{
  return "{"
    ...
    "	\"category\" : 1,"
    "   \"seller_term_dict\": ["
    "		{ \"src_text\" : \"premier\", \"dst_text\" : \"First\", \"src_lang\": \"\", \"dst_lang\": \"\", \"frequency\": 10 },"
    "		{ \"src_text\" : \"T-shirt with\", \"dst_text\" : \"t-shirt avec\", \"src_lang\": \"EN\", \"dst_lang\": \"ES\", \"frequency\": 5 }"
    "   ],"
    "   \"approved_term_dict\": ["
    "		{ \"src_text\" : \"premier\", \"dst_text\" : \"New\", \"category\": 2, \"frequency\": 10, \"change_probability\": 0.451 },"
    "		{ \"src_text\" : \"premier\", \"dst_text\" : \"Brand-new\", \"category\": 1, \"frequency\": 2, \"change_probability\": 0.21 }"
    "   ],"
    "   \"brands\": ["
    "		{ \"src_text\" : \"logo\", \"dst_text\" : \"LogoBrand\", \"category\": 1, \"source\": \"dict\" },"
    "		{ \"src_text\" : \"logo\", \"dst_text\" : \"AnotherCategoryBrand\", \"category\": 8, \"source\": \"dict\" },"
    "		{ \"src_text\" : \"logo\", \"dst_text\" : \"Logo\", \"source\": \"tagger\" }"
    "   ],"
