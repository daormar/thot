...
//---------------------------------------
void LevelDbPhraseTableTest::testRetrievingSubphrase()
{
  /* TEST:
...
//---------------------------------------
void LevelDbPhraseTableTest::testRetrieveNonLeafPhrase()
{
  /* TEST:
...
//---------------------------------------
void LevelDbPhraseTableTest::testGetEntriesForSource()
{
  /* TEST:
...
//---------------------------------------
void LevelDbPhraseTableTest::testRetrievingEntriesWithCountEqualZero()
{
  /* TEST:
...
//---------------------------------------
void LevelDbPhraseTableTest::testGetNbestForTrg()
{
  /* TEST:
...
void LevelDbPhraseTableTest::testIteratorsOperatorsEqualNotEqual()
{
  ...
  */
  ...
  LevelDbPhraseTable::const_iterator iter1 = tab->begin();
  iter1++;
  LevelDbPhraseTable::const_iterator iter2 = tab->begin();
...
//---------------------------------------
void LevelDbPhraseTableTest::testSubkeys()
{
  /* TEST:
