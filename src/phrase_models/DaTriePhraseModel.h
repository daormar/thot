...
/*                                                                  */
/* Prototype file: DaTriePhraseModel                                */
/*                                                                  */
/* Description: Defines the DaTriePhraseModel base class.           */
/*              DaTriePhraseModel is derived from the abstract      */
/*              class BasePhraseModel and implements a phrase       */
/*              model stored and accessed using Berkeley databases. */
/*                                                                  */
/********************************************************************/

#ifndef _DaTriePhraseModel_h
#define _DaTriePhraseModel_h
...
//--------------- DaTriePhraseModel class

class DaTriePhraseModel: public BaseCountPhraseModel
{
 public:
 ...
 protected:
    ...
    DaTriePhraseTable daTriePhraseTable;
