...
class BasePhraseModel
{
 public:
	...
	virtual bool getNbestTransFor_t_(const Vector<WordIndex>& t,
        ...
        // Functions to maintain backward compatibility with version
        // 2.0.2 Beta and the previous ones
 	Prob pf_e_(const Vector<string>& e,const Vector<string>& f)
      {
        return strPt_s_(e,f);
      }
 	LgProb logpf_e_(const Vector<string>& e,const Vector<string>& f)
      {
        return strLogpt_s_(e,f);
      }
    Prob pf_e_(const Vector<WordIndex>& e,
               const Vector<WordIndex>& f)
      {
        return pt_s_(e,f);
      }
 	LgProb logpf_e_(const Vector<WordIndex>& e,
                    const Vector<WordIndex>& f)
      {
        return logpt_s_(e,f);
      }
 	Prob pe_f_(const Vector<string>& f,const Vector<string>& e)
      {
        return strPs_t_(e,f);
      }
 	LgProb logpe_f_(const Vector<string>& f,const Vector<string>& e)
      {
        return strLogps_t_(e,f);
      }
    Prob pe_f_(const Vector<WordIndex>& f,
               const Vector<WordIndex>& e)
      {
        return ps_t_(e,f);
      }
    LgProb logpe_f_(const Vector<WordIndex>& f,
                    const Vector<WordIndex>& e)
      {
        return logps_t_(e,f);
      }
    bool getTransFor_e_(const Vector<string>& e,TrgTableNode& trgtn)
      {
        return strGetTransFor_s_(e,trgtn);
      }
    bool getTransFor_e_(const Vector<WordIndex>& e,
                        TrgTableNode& trgtn)
      {
        return getTransFor_s_(e,trgtn);
      }
    bool getTransFor_f_(const Vector<string>& f,SrcTableNode& srctn)
      {
        return strGetTransFor_t_(f,srctn);
      }
    bool getTransFor_f_(const Vector<WordIndex>& f,
                        SrcTableNode& srctn)
      {
        return getTransFor_t_(f,srctn);
      }
    bool getNbestTransFor_e_(const Vector<string>& e,
                             NbestTableNode<PhraseTransTableNodeData>& nbt)
      {
        return strGetNbestTransFor_s_(e,nbt);
      }
	bool getNbestTransFor_e_(const Vector<WordIndex>& e,
                             NbestTableNode<PhraseTransTableNodeData>& nbt)
      {
        return getNbestTransFor_s_(e,nbt);
      }
    bool getNbestInvTransFor_f_(const Vector<string>& f,
                                NbestTableNode<PhraseTransTableNodeData>& nbt,
                                int N=-1)
      {
        return strGetNbestTransFor_t_(f,nbt,N);
      }
    bool getNbestInvTransFor_f_(const Vector<WordIndex>& f,
                                NbestTableNode<PhraseTransTableNodeData>& nbt,
                                int N=-1)
      {
        return getNbestTransFor_t_(f,nbt,N);
      }
