...
/**
 * @file thot_filter_bin_ilextable.cc
 * 
 * @brief Filters lexical parameters given a lexical table and a file
 * with filtering information generated by means of the
 * gen_bin_lex_filter_info tool.
 */
