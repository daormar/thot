...
void printUsage(void)
{
  ...
  cerr<<"-lf <float>           Set lexical smoothing interpolation factor\n";
  cerr<<"                      (only available for HMM-based alignment models).\n";
  cerr<<"                      NOTE: this option has no effect when combined with\n";
  cerr<<"                      the -l option.\n";
  cerr<<"-af <float>           Set alignment smoothing interpolation factor\n";
  cerr<<"                      (only available for HMM-based alignment models).\n";
  cerr<<"                      NOTE: this option has no effect when combined with\n";
  cerr<<"                      the -l option.\n";
  cerr<<"-np <float>           Set probability value for the NULL word alignment.\n";
  cerr<<"                      (only available for HMM-based alignment models\n";
